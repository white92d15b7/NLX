/* src/config/nullex-config.h.  Generated from nullex-config.h.in by configure.  */
/* src/config/nullex-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "InstaCash Core 1.1.0"
