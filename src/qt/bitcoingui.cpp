                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NulleX Core - Testnet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NulleX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and NulleX: URIs)"));
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/masternodes"), tr("&Null Array MN's"), this);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NulleX Core"), this);
    aboutAction->setStatusTip(tr("Show information about NulleX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NulleX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NulleX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NulleX addresses"));
    ...
    openAction->setStatusTip(tr("Open a NulleX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NulleX Core help message to get a list with possible NulleX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NulleX Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("NulleX Core"); // default title
