                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zNLX || context == Context::BIP_38) {
    ...
    if (context == Context::Send_NLX || context == Context::Send_zNLX) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR NLX</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
