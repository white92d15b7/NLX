...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NulleX Core NulleX-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  NulleX-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded NulleX transaction") + "\n" +
                               "  NulleX-tx [options] -create [commands]   " + _("Create hex-encoded NulleX transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded NulleX transaction
