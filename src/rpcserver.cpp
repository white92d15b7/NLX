...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NulleX features */
        {"NulleX", "masternode", &masternode, true, true, false},
        {"NulleX", "listmasternodes", &listmasternodes, true, true, false},
        {"NulleX", "getmasternodecount", &getmasternodecount, true, true, false},
        {"NulleX", "masternodeconnect", &masternodeconnect, true, true, false},
        {"NulleX", "masternodecurrent", &masternodecurrent, true, true, false},
        {"NulleX", "masternodedebug", &masternodedebug, true, true, false},
        {"NulleX", "startmasternode", &startmasternode, true, true, false},
        {"NulleX", "createmasternodekey", &createmasternodekey, true, true, false},
        {"NulleX", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"NulleX", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"NulleX", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"NulleX", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"NulleX", "getmasternodescores", &getmasternodescores, true, true, false},
        {"NulleX", "mnbudget", &mnbudget, true, true, false},
        {"NulleX", "preparebudget", &preparebudget, true, true, false},
        {"NulleX", "submitbudget", &submitbudget, true, true, false},
        {"NulleX", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"NulleX", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"NulleX", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"NulleX", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"NulleX", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"NulleX", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"NulleX", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"NulleX", "checkbudgets", &checkbudgets, true, true, false},
        {"NulleX", "mnsync", &mnsync, true, true, false},
        {"NulleX", "spork", &spork, true, true, false},
        {"NulleX", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"NulleX", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> NulleX-cli " + methodname + " " + args + "\n";
}
