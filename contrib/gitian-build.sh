...
VERSION=
commit=false
url=https://github.com/BlockTamer/NLX
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/BlockTamer/NLX
...
then
    ...
    git clone https://github.com/BlockTamer/gitian.sigs.git
    git clone https://github.com/BlockTamer/nullex-detached-sigs.git
